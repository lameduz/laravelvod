...
@section('content')
        ...
        <div class="portlet-body blue">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    {!! Form::text('org_type',null,['class'=> 'form-control','readonly'])!!}
                    {!! Form::label('siren','Numéro de SIREN') !!}
                    {!! Form::text('org_siren',null,['class'=> 'form-control','readonly']) !!}

                    {!! Form::label('org_ape_naf','Numéro APE NAF') !!}
                    {!! Form::text('org_ape_naf',null,['class'=> 'form-control','readonly']) !!}
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    {!! Form::text('adress_1',null,['class'=> 'form-control','readonly']) !!}
                    {!! Form::label('adress_2','Adresse n°2') !!}
                    {!! Form::text('adress_2',null,['class'=> 'form-control','readonly']) !!}
                    {!! Form::label('zipcode','Code postal') !!}

                    {!! Form::text('zipcode',null,['class'=> 'form-control','readonly']) !!}
    ...
    <div class="col-md-4">
        <button class="btn" id="edit-btn">Modifier des informations</button>
